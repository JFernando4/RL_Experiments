...
from Demos.Demos_Utility.Saving_Restoring_NN_Util import NN_Agent_History, restore_graph
...
def main():
    ...
    agent.fa.model.print_number_of_parameters(agent.fa.model.train_vars[1])
    training_loop(rl_agent=agent, iterations=500, episodes_per_iteration=1, render=False, agent_render=False,
