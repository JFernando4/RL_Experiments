...
def main():
    ...
    if restore:
        ...
        bpolicy = EpsilonGreedyPolicy(env.get_num_actions(), epsilon=0.5)
        gamma = 1
        n = 20
        beta = 1
        sigma = 0.5
    ...
    training_loop(rl_agent=agent, iterations=1000, episodes_per_iteration=10, render=False, agent_render=False,
