...
def main():
    ...
    srcpath = homepath + "PycharmProjects/RL_Experiments/Demos/Sequest_Test/"
    ...
    training_loop(rl_agent=agent, iterations=10, episodes_per_iteration=1, render=True, agent_render=False,
